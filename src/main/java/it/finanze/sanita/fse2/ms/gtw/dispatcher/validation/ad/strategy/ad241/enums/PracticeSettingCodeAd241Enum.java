...
public enum PracticeSettingCodeAd241Enum {
    ...
    AD_PSC082("AD_PSC078", "Anestesia e Rianimazione"),
    ...
    AD_PSC127("AD_PSC127", "Hospice Ospidaliero"),
	...
	PracticeSettingCodeAd241Enum(String inCode, String inDescription) {
		code = inCode;
	...
	public static boolean isValidCode(String code) {
		...
		for (PracticeSettingCodeAd241Enum value : values()) {
