...
@Getter
@AllArgsConstructor
public enum DocumentType263Enum {
    ...
    public static DocumentType263Enum getByCode(String code) {
        for (DocumentType263Enum documentTypeEnum : DocumentType263Enum.values()) {
