...
public enum PracticeSettingCodeAd24Enum {
	...
	AD_PSC999("AD_PSC999", "Astrologia");
	...
	PracticeSettingCodeAd24Enum(String inCode, String inDescription) {
		code = inCode;
	...
	public static boolean isValidCode(String code) {
		...
		for (PracticeSettingCodeAd24Enum value : values()) {
