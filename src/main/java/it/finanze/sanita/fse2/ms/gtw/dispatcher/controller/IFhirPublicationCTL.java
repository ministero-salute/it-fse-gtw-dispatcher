...
public interface IFhirPublicationCTL {
	...
	@DeleteMapping(value = "/fhir-documents/{idDoc}", produces = { MediaType.APPLICATION_JSON_VALUE })
	...
	@PutMapping(value = "/fhir-documents/{idDoc}/metadata-iti-57", produces = { MediaType.APPLICATION_JSON_VALUE })
	@ApiResponse(content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = PublicationResDTO.class)))
