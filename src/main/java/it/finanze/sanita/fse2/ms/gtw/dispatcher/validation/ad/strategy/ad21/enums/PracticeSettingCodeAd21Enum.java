 ...
 */
package it.finanze.sanita.fse2.ms.gtw.dispatcher.validation.ad.strategy.ad21.enums;

import lombok.Getter;

public enum PracticeSettingCodeAd21Enum {
	...
	PracticeSettingCodeAd21Enum(String inCode, String inDescription) {
		code = inCode;
	...
	public static boolean isValidCode(String code) {
		...
		for (PracticeSettingCodeAd21Enum value : values()) {
