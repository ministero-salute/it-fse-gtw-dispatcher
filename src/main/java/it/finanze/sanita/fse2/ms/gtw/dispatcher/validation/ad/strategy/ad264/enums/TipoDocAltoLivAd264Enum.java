...
@Getter
public enum TipoDocAltoLivAd264Enum {
	...
	private TipoDocAltoLivAd264Enum(String inCode, String inDescription) {
		code = inCode;
	...
	public static TipoDocAltoLivAd264Enum getByCode(String code) {
		if (code == null)
			return null;
		for (TipoDocAltoLivAd264Enum value : values()) {
