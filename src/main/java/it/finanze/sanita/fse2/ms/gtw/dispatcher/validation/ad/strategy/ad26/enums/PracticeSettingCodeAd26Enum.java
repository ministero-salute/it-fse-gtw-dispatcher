...
public enum PracticeSettingCodeAd26Enum {
    ...
    AD_PSC041("AD_PSC041", "Medicina termale"), //NEW
	...
	PracticeSettingCodeAd26Enum(String inCode, String inDescription) {
		code = inCode;
	...
	public static boolean isValidCode(String code) {
		...
		for (PracticeSettingCodeAd26Enum value : values()) {
