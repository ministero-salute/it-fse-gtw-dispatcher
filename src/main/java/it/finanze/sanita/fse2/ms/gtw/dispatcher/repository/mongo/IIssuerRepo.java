...
/**
 * Repository interface for Issuer data access operations.
 */
public interface IIssuerRepo {
     ...
     * Find issuer by name.
     * 
     * @param name The issuer name (from JWT iss field)
     * @return IssuerETY or null if not found
     */
    IssuerETY getByName(String name);
}
