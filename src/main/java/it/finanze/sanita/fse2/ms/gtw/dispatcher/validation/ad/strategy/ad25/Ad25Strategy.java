 ...
 */
package it.finanze.sanita.fse2.ms.gtw.dispatcher.validation.ad.strategy.ad25;
...
import it.finanze.sanita.fse2.ms.gtw.dispatcher.validation.ad.strategy.ad25.enums.*;
...
/**
 * Affinity Domain Strategy for version 2.5 (effective from June 2025)
 * Based on IHE ITI specifications for metadata update (ITI-57)
 * Adds documentSigned slot requirement compared to v2.4.1
 * 
 * @see AbstractAffinityDomainStrategy
 */
@Slf4j
@Component
public class Ad25Strategy extends AbstractAffinityDomainStrategy {

    // Version metadata
    private static final String VERSION_ID = "2.5";
    private static final LocalDate EFFECTIVE_FROM = LocalDate.of(2023, 12, 12);
    ...
    protected void validateValueSetsInternal(UpdateMetadataReqDTO request, List<String> validationErrors) {
        ...
        validateFieldList(request.getAdministrativeRequest(), AdministrativeReqAd25Enum::isValidCode,
                "administrativeRequest", "XDSDocumentEntry.Slot – administrativeRequest", validationErrors);

        validateField(request.getTipologiaStruttura(), HealthcareFacilityAd25Enum::isValidCode,
