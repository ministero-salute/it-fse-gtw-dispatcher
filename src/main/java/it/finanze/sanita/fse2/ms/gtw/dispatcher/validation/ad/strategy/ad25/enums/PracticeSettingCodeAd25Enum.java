 ...
 */
package it.finanze.sanita.fse2.ms.gtw.dispatcher.validation.ad.strategy.ad25.enums;

import lombok.Getter;

public enum PracticeSettingCodeAd25Enum {
	...
	PracticeSettingCodeAd25Enum(String inCode, String inDescription) {
		code = inCode;
	...
	public static boolean isValidCode(String code) {
		...
		for (PracticeSettingCodeAd25Enum value : values()) {
