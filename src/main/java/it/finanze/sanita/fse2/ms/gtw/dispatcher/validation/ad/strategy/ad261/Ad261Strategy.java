 ...
 */
package it.finanze.sanita.fse2.ms.gtw.dispatcher.validation.ad.strategy.ad261;
...
import it.finanze.sanita.fse2.ms.gtw.dispatcher.validation.ad.strategy.ad261.enums.*;
...
/**
 * Affinity Domain Strategy for version 2.6.1 (effective from June 2025)
 * Based on IHE ITI specifications for metadata update (ITI-57)
 * Same requirements as v2.6
 * 
 * @see AbstractAffinityDomainStrategy
 */
@Slf4j
@Component
public class Ad261Strategy extends AbstractAffinityDomainStrategy {

    // Version metadata
    private static final String VERSION_ID = "2.6.1";
    private static final LocalDate EFFECTIVE_FROM = LocalDate.of(2025, 6, 15);
    ...
    private static final Set<String> MANDATORY_SUBMISSION_SET_FIELDS = Set.of(
            // Slots
            "slot:submissionTime", // XDSSubmissionSet.submissionTime
            // Classifications (by scheme URN)
    ...
    protected void validateValueSetsInternal(UpdateMetadataReqDTO request, List<String> validationErrors) {
        ...
        validateFieldList(request.getAdministrativeRequest(), AdministrativeReqAd261Enum::isValidCode,
                "administrativeRequest", "XDSDocumentEntry.Slot - administrativeRequest", validationErrors);

        validateField(request.getTipologiaStruttura(), HealthcareFacilityAd261Enum::isValidCode,
