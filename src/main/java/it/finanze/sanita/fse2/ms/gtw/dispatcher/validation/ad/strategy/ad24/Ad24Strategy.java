...
/**
 * Affinity Domain Strategy for version 2.4 (effective from December 2022)
...
@Slf4j
@Component
public class Ad24Strategy extends AbstractAffinityDomainStrategy {

        // Version metadata
        private static final String VERSION_ID = "2.4";
        private static final LocalDate EFFECTIVE_FROM = LocalDate.of(2022, 12, 1);
        ...
        validateField(request.getTipologiaStruttura(), HealthcareFacilityAd24Enum::isValidCode,
