...
public enum RestExecutionResultEnum {
    ...
    VALIDATION_EXCEPTION("/errors/validation", "Errore di validazione", ErrorLogEnum.KO_VAL, EventStatusEnum.BLOCKING_ERROR),
	...
	FHIR_MATCH_ERROR("/msg/fhir-match", "Errore in fase di recupero dell'esito della verifica.", ErrorLogEnum.KO_VAL, EventStatusEnum.BLOCKING_ERROR),
